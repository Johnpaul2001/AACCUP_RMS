<?php
    ...
    $_POST['table']['table_headers'] = array('Program_Code', 'Program_Name');
    $_POST['table']['table_data'] = array();
    foreach ($_PROGRAMS as $code => $program) {
        $_POST['table']['table_data'][] = array('Program_Code' => $code, 'Program_Name' => $program);
    }
?>
