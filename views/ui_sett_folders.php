    ...
    <main class="fade-in-down">
        <section class="px-2">
            <div class="section-title">
                <h2> FOLDERS </h2>
                <p style="font-size:25px ;"><b>Manage Folder List</b></p>
            </div>
        </section>
        <div class="bg-light d-flex flex-column justify-content-between" style="width: 100% !important;">
            <label for="formFile" class="form-label"><p class="px-2" style="color: blue; font-size: 20px;">Select the TSV (Tab Separated Value) file to Upload List of Folders</p></label>
